...
{
    public class RecipeForCuisineViewModel : ASelectedListViewModel<RecipeForView, CuisineTypeForView>
    {
        public RecipeForCuisineViewModel() : base("")
        {
            selectedTableName = "CuisineType";
